...
public class ResponseHotPepperBudgetBean {
    ...
    private List<HotPepperBudgetBean> budgetList;
    ...
    public List<HotPepperBudgetBean> getBudgetList() {
        return this.budgetList;
    }
    
    public void setBudgetList( List<HotPepperBudgetBean> budgetList) {
